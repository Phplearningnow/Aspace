...
<?php if (redux_demo_get_option('lay_header') == 1 ) { ?>
		<?php get_template_part('template-parts/content-header-right-shop'); ?>
	
		<?php  } else if (redux_demo_get_option('lay_header') == 12 ) { ?>
			<?php get_template_part('template-parts/content-header-left-shop'); ?>
<?php } elseif (redux_demo_get_option('lay_header') == 2 ) { ?>
			<?php get_template_part('template-parts/content-header-shop'); ?>
<?php }  ?>
