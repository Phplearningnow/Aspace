...
//    dry: args['dry'] || false,
//    from: [packageName, lowercaseDash, inAString, lowerCaseUnderscore, internationalize, `Theme Name: ${fromName}`, `Theme URI: https://aspace.press/` ],
...
const questions = [
   ...
   },
   {
      type: 'text',
      name: 'slug',
      message: 'aspace (no-spaces)'
   },
   {
      type: 'text',
      name: 'uri',
      message: 'Theme URI',
      initial: 'https://aspace.dronstar.com/'
   },
   {
      type: 'text',
      name: 'author',
      message: 'Author',
      initial: 'Fernando and Eric Greenfield'
   },
   {
      type: 'text',
      name: 'authorUri',
      message: 'Author URI',
      initial: 'https://dronstar.com/'
   },
   {
      type: 'text',
      name: 'description',
      message: 'Description',
      initial: 'An amazing theme built with aspace, wordpress and aspace'
   },
   {
      type: 'text',
      name: 'server',
      message: 'Development or Remote Url',
      initial: 'aspace.local'
   },
   {
      type: 'confirm',
      name: 'ssl',
